...
public class MainActivity extends AppCompatActivity implements
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            /*If a Loader is not already started, the LoaderManager calls
            startLoading(), which puts the Loader in a started state and
            immediately calls the Loader’s onStartLoading() method.*/

            //This function will automatically be called when the
            //associated activity/fragment is being started
            @Override
            protected void onStartLoading() {
                ...
                if (mGithubJson != null) {
                    ...
                    /*Force an asynchronous load. Unlike Loader.StartLoading this will ignore a
                     previously loaded data set and load a new one. This simply calls through to
                     the implementation's Loader.OnForceLoad.
                     You generally should only call this when the loader is
                     started -- that is, Loader.IsStarted returns true.*/
                    forceLoad(); //This basically run the loader
                }
            }
